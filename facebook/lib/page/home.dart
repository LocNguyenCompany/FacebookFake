  ...
  return Container(
    ...
    child: ListView(
      ...
      children: [
        ...
        story('images/content2.jpg', 'images/xebuyt.jpg',
...
Container _post(String avt, String name, String time, IconData icon,
    String urlImage, String numberlike) {
  // ignore: avoid_unnecessary_containers
    ...
    return Container(
        ...
        child: ListView(
          ...
          children: [
            _live(),
            _storys(),
            _post('images/dhhh.jpg', 'Đại học hài hước', '3 giờ trước',
                Icons.public, 'images/content1.jpg', "Tú +12345"),
            _post('images/xebuyt.jpg', 'Xe Buýt TP. Hồ Chí Minh', '08/11/2021',
                Icons.public, 'images/content2.jpg', "Tú +12345"),
            _post('images/topdev.jpg', 'TopDev', '08/11/2021', Icons.public,
                'images/content3.jpg', "Tú +12345"),
            _post('images/dhhh.jpg', 'Đại học hài hước', '3 giờ trước',
                Icons.public, 'images/content1.jpg', "Tú +12345"),
            _post('images/xebuyt.jpg', 'Xe Buýt TP. Hồ Chí Minh', '08/11/2021',
                Icons.public, 'images/content2.jpg', "Tú +12345"),
